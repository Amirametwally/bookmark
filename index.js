...
// Create a new bookmark object with the specified name and URL.
...
// display bookmark information in the table
function displayBookmark(indexOfWebsite) {
  ...
  var newBookmark = `
              <tr>
                ...
                <td>
                  <button class="btn btn-visit" data-index="${indexOfWebsite}">Visit
                  </button>
                </td>
                <td>
  ...
  // delete bookmark from bookmark list and update bookmark list
  ...
  // visit bookmark list and update bookmark list
...
// submit the form again  with the new value
